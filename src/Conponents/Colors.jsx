...
export default function Colors() {
  ...
  return (
    <>
      <section className="mx-5 content-start lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 grid gap-3 rounded-md">
        {Colors.map((item, key) => (
          <div
            key={key}
          ...
          >
            ...
            <span className="bg-red-50 text-red-500 font-medium px-2.5 py-0.5 rounded">
              {item.tag}
            </span>
          </div>
        ))}
